...
export default function BtnOpcoesDeParticipantes({participante, disabled}:{participante:participantesType, disabled:boolean}) {
  ...
  return (
    <div>
            <Tooltip title="Opções do participante">
      ...
      >
        <MenuItem  disableRipple>
          <EditIcon />
          <ModalAtualizarParticipante elenco={participante}/>
        </MenuItem>
        <MenuItem disableRipple>
          <DeleteOutlineIcon />
